...
namespace Rocosa_AccesoDatos.Migrations
{
    ...
    [Migration("20241025140719_AgregarVentaYVentaDetalle")]
    partial class AgregarVentaYVentaDetalle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rocosa_Modelos.Orden", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rocosa_Modelos.OrdenDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rocosa_Modelos.Venta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rocosa_Modelos.VentaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rocosa_Modelos.UsuarioAplicacion", b =>
                {
            ...
            modelBuilder.Entity("Rocosa_Modelos.Orden", b =>
                {
                    b.HasOne("Rocosa_Modelos.UsuarioAplicacion", "UsuarioAplicacion")
                        .WithMany()
            ...
            modelBuilder.Entity("Rocosa_Modelos.OrdenDetalle", b =>
                {
                    b.HasOne("Rocosa_Modelos.Orden", "Orden")
                        .WithMany()
                        .HasForeignKey("OrdenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rocosa_Modelos.Producto", "Producto")
                        .WithMany()
            ...
            modelBuilder.Entity("Rocosa_Modelos.VentaDetalle", b =>
                {
                    ...
                    b.HasOne("Rocosa_Modelos.Venta", "Venta")
                        .WithMany()
